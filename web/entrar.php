...
$result = mysqli_query($link,"SELECT nombre, clave FROM usuarios WHERE nombre='$usuario' and clave='$clave'");
							
$nr = mysqli_num_rows($result);
if($nr == 1){
	$_SESSION['nombre']=$usuario;
	echo ("<h1 class='text-center'>Te has logueado correctamente</h1>");
}
else
	echo ("<h1 class='text-center'>Error, vuelva a intentarlo</h1>");
