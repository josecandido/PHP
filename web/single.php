    ...
    controlNav: "thumbnails"
					...
					<div class="col-md-5 single-top-in simpleCart_shelfItem">
						...
						<h4>Lorem Ipsum</h4>
							...
							<p>Cabecero tapizado en polipiel con elegante diseño. Disponible en varios colores y medidas. </p>
							<div class="available">
								<ul>
									<li>Color
										<select>
								...
								<a href="#" class="add-cart item_add">AÑADIR AL CARRO</a>
		...
		<div class=" bottom-product">
					<div class="col-md-4 bottom-cd simpleCart_shelfItem">
						<div class="product-at ">
							...
							<div class="pro-grid">
										<span class="buy-in">AÑADIR AL CARRO</span>
							</div>
						</a>	
						</div>
